...
class Account extends Service {
  ...
  Future<models.Account> create(
      {required String userId, required String email, required String password, String? name}) async {
    const String path = '/account';
  ...
  ///
  Future<models.Account> updatePhone({required String number, required String password}) async {
