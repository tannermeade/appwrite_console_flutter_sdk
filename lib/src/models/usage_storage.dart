...
class UsageStorage implements Model {
    ...
    final List<MetricList> tagsStorage;
    ...
    factory UsageStorage.fromMap(Map<String, dynamic> map) {
        return UsageStorage(
            ...
            tagsStorage: List<MetricList>.from(map['tagsStorage'].map((p) => MetricList.fromMap(p))),
    ...
    Map<String, dynamic> toMap() {
        return {
            ...
            "tagsStorage": tagsStorage.map((p) => p.toMap()),
